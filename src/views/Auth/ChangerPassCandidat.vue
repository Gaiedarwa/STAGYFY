        ...
        <v-card>
          <v-list style="background-color: #0db39e ">
            <v-list-item >
              ...
              <v-list-item-content>
                <!-- <v-list-item-title> {{ profil.firstname }} {{ profil.lastname }}</v-list-item-title>
          ...
          <v-card-actions class="justify-end">
            <v-btn @click="changer()">modifier</v-btn>
          </v-card-actions>
        </v-card>
...
export default {
  ...
  methods: {
    ...
    changer() {
      ...
      axios
        .put(
          `http://127.0.0.1:8000/api/changerpasswordCandidat/${localStorage.getItem(
            "id"
          )}`,
          {
